...
public class Animal
{
    ...
    public Animal(int _code, string _name, AnimalType _type, string _info, string _hiddenInfo, string _hello, string _script_good, string _script_bad, Recipe _recipe, int _moneyCondition, MoodType _moodType, 
